<?php
/**
 * Shared login/session history page (admin + portal entrypoints).
 * Loaded by admin/sessions.php and portal/sessions.php — do not delete either URL.
 */
...
$isAdminCtx = isStaff();
if ($isAdminCtx) require_once __DIR__ . '/admin-layout.php';
else            require_once __DIR__ . '/portal-layout.php';
...
<?php
if ($isAdminCtx) require_once __DIR__ . '/admin-layout-close.php';
else            require_once __DIR__ . '/portal-layout-end.php';
