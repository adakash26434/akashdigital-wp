...
<div id="aft-form" <?=$afActive==='list'?'style="display:none"':''?>>
  <div class="st-card p-tile">
    <div class="af-editor-header">
      <h3 class="h-eyebrow-tight" style="margin:0;"><?=$editing?'Edit Testimonial':'Add Testimonial'?></h3>
    ...
    <form method="POST" class="col-1-tight">
      ...
      <div class="af-form-footer">
        <button type="submit" class="btn btn-primary flex-1"><?=$editing?'Update':'Add Testimonial'?></button>
