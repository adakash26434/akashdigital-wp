...
<div style="position:sticky;bottom:0;z-index:50;margin-top:1.5rem;background:var(--background);border-top:1px solid var(--border);padding:1rem 0;display:flex;align-items:center;gap:.875rem;flex-wrap:wrap;">
  <button type="submit" id="saveBtn" class="btn btn-primary btn-md" style="min-width:10rem;" onclick="this.disabled=true;this.innerHTML='<i data-lucide=\'loader-2\' class=\'ic-15\' style=\'animation:spin 1s linear infinite;\'></i> Saving...';this.style.opacity='0.7';">
