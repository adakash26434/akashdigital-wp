...
try {
    $staff = query(
        "SELECT u.*,
         ...
         ORDER BY CASE u.role WHEN 'superadmin' THEN 1 WHEN 'admin' THEN 2 WHEN 'support' THEN 3 ELSE 4 END, u.display_name"
    );
  ...
  <div class="st-card p-tile">
    ...
    <form method="POST" class="col-1">
      ...
      <div>
        ...
        <input type="email" name="email" required class="form-input" placeholder="staff@company.com">
      </div>
      <div>
